...
if __name__ == "__main__":
    ...
    while(1):
        ...
        print(f"acc X: {accel_data['x']}")
        print(f"acc Y: {accel_data['y']}")
        print(f"acc Z: {accel_data['z']}")
        gyro_data = mpu.get_gyro_data()
        print(f"omeg X: {gyro_data['x']}")
        print(f"omeg Y: {gyro_data['y']}")
        print(f"omeg Z: {gyro_data['z']}")
        print("")
        sleep(1)